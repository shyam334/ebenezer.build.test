...
resolvers ++= Seq(
  ...
  resolvers ++= Seq(
  Resolver.url("Cloudera third party", new URL("https://repository.cloudera.com/content/repositories/third-party/"))(Patterns("[organization]/[module]/[revision]/[module]-[revision].[ext]") )
  )
